...
public class Conduits {
    ...
    public static void bootstrap(BootstrapContext<Conduit<?>> context) {
        ...
        context.register(ENHANCED_ENERGY, new EnergyConduit(EnderIOBase.loc("block/conduit/enhanced_energy"),
                ConduitLang.ENHANCED_ENERGY_CONDUIT, 12_000));
        context.register(ENDER_ENERGY, new EnergyConduit(EnderIOBase.loc("block/conduit/ender_energy"),
                ConduitLang.ENDER_ENERGY_CONDUIT, 48_000));

        context.register(REDSTONE, new RedstoneConduit(EnderIOBase.loc("block/conduit/redstone"),
                EnderIOBase.loc("block/conduit/redstone_active"), ConduitLang.REDSTONE_CONDUIT));

        context.register(FLUID,
                new FluidConduit(EnderIOBase.loc("block/conduit/fluid"), ConduitLang.FLUID_CONDUIT, 50, false));
        context.register(PRESSURIZED_FLUID, new FluidConduit(EnderIOBase.loc("block/conduit/pressurized_fluid"),
                ConduitLang.PRESSURIZED_FLUID_CONDUIT, 100, false));
        context.register(ENDER_FLUID, new FluidConduit(EnderIOBase.loc("block/conduit/ender_fluid"),
        ...
        // ItemConduit(EnderIOBase.loc("block/conduit/item"),
